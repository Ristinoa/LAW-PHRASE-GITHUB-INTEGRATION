...
translate spanish strings:
    ...
    new "Función de voz en el portapapeles habilitada."
    ...
    new "La compatibilidad con la función de voz propia es limitada al usar una pantalla táctil."
    ...
    new "Caída de volumen con auto-voz"
    ...
    new "Haga clic para establecer la transformación, haga clic con el botón derecho para agregarla a la lista de transformaciones."
    ...
    new "Haga clic para configurar, haga clic con el botón derecho para agregar a la lista de elementos pendientes."
    ...
    new "¿Está seguro de que desea finalizar la repetición?"
    ...
    new "¿Estás seguro de que quieres saltarte el diálogo no visto y pasar a la siguiente opción?"

    # renpy/common/00gui.rpy:459
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "Este guardado se creó en un dispositivo diferente. Los archivos de guardado creados con fines maliciosos pueden dañar su ordenador. ¿Confías en el creador de esta partida guardada y en todos los que podrían haber modificado el archivo?"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "¿Confías en el dispositivo en el que se creó la copia de seguridad?\" Solo debes seleccionar \"sí\" si eres el único usuario del dispositivo."
    ...
    new "Este programa contiene software libre bajo varias licencias, incluidas la Licencia MIT y la Licencia Pública General Reducida de GNU. Puede encontrar una lista completa del software, incluyendo enlaces al código fuente completo, {a=https://www.renpy.org/l/license}aquí{/a}."
    ...
    old "self voicing volume drop"
    new "caída de volumen por auto-voz"
    ...
    new "desactivar la función de voz del portapapeles"
    ...
    new "habilitar la función de depuración"

    # renpy/common/00preferences.rpy:473
    old "debug voicing disable"
    new "deshabilitar la depuración de voz"
    ...
    new "Voz en off del portapapeles habilitada. Pulsa 'Shift+C' para desactivarlo."

    # renpy/common/00preferences.rpy:725
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "La auto-voz diría \\\"[renpy.display.tts.last]\\\". Pulsa 'Alt+Shift+V' para desactivarlo."

    # renpy/common/00preferences.rpy:727
    old "Self-voicing enabled. Press 'v' to disable."
    new "Autocomunicación habilitada.\" Pulsa 'v' para desactivar."
    ...
    new "El servidor Ren'Py Sync no tiene una copia de esta sincronización. Es posible que el ID de sincronización no sea válido o que haya expirado el tiempo de espera."

    # renpy/common/00sync.rpy:305
    old "Please enter the sync ID you generated.\nNever enter a sync ID you didn't create yourself."
    new "Por favor, introduzca el ID de sincronización que generó.\\nNunca introduzca un ID de sincronización que no haya creado usted mismo."
    ...
    new "O bien este proyecto no admite actualizaciones, o bien se eliminó el archivo de estado de actualización."
    ...
    new "Desglosando las actualizaciones."
    ...
    new "Imagen [índice] de [cantidad] bloqueada."
    ...
    new "Este ordenador tiene un problema al mostrar gráficos: [problema]."
    ...
    new "Intenta revertir a un momento anterior, lo que le permite guardar o elegir una opción diferente."
    ...
    new "Ignora la excepción, permitiéndote continuar. Esto suele dar lugar a errores adicionales."
